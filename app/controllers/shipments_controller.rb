class ShipmentsController < ApplicationController
  ...
  # POST /shipments.xml
  def create
    @shipment = Shipment.new(params[:shipment].merge(:user_id=>current_user.id))

    respond_to do |format|
      if @shipment.save
        format.html { redirect_to(new_shipment_payment_path(@shipment), :notice => 'Shipment was successfully created.') }
